...
<div class="gifts-holder">
	<div class="page-inner page-inner--w1">
		<div class="page-heading">
			...
			<div class="page-description">
				<div class="page-inner page-inner--w2">
					<div class="page-text">
						Вы можете выбрать <b><?php echo (int)$arBasketItem["QUANTITY"] ?></b> подарков.
						<br />
		...
		<?php
			...
			$isGiftsFilter = [
				"PROPERTY_PODAROK" => $arProduct["PROPERTY_PREDLAGAT_PODAROK_VALUE"],
				">CATALOG_QUANTITY" => 0,
			];
			$APPLICATION->IncludeComponent(
				...
				Array(		
				    ...
				    "GIFTS_IN_BASKET" => $arGifts,
				)
			);
		?>
	</div>
	
	<div class="gifts-bar", data-info='{"max": <?php echo (int)$arBasketItem["QUANTITY"] ?>, "basket_id": "<?php echo $arBasketItem["ID"] ?>"}'>
		<div class="page-inner page-inner--w1">
			<div class="gifts-bar-inner">
				<div class="gifts-bar-counter">
					...
					<div class="gifts-bar-counter-nums">
						...
						<span class="gifts-bar-counter-num-all"><?php echo (int)$arBasketItem["QUANTITY"] ?></span>
					</div>
				</div>
