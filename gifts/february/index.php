...
<div class="gifts-holder">
	<div class="page-inner page-inner--w1">
		<div class="page-heading">
			...
			<div class="page-description">
				<div class="page-inner page-inner--w2">
					<div class="page-text">
						Вы можете выбрать <b><?php echo $giftsParams[$giftsType]["COUNT"]; ?></b> подарков.
						<?php if($giftsParams[$giftsType]["DIVIDE_GIFTS"]): ?><br /><b>По одному из каждой категории</b><?php endif; ?>
						<br />
		...
		<?php
			...
			if(!$giftsParams[$giftsType]["DIVIDE_GIFTS"]) {
				$isGiftsFilter = [
					"PROPERTY_PODAROK" => $giftsParams[$giftsType]["ARTICLES"]
				];
				$APPLICATION->IncludeComponent(
					...
					Array(		
						...
						"ELEMENT_SORT_FIELD" => "PROPERTY_PODAROK",
					    ...
					    "DIVIDE_GIFTS" => $giftsParams[$giftsType]["DIVIDE_GIFTS"],
					)
				);
			} else {
				
				$isGiftsFilter1 = [
					"PROPERTY_PODAROK" => $giftsParams[$giftsType]["ARTICLES"][0]
				];
				$isGiftsFilter2 = [
					"PROPERTY_PODAROK" => $giftsParams[$giftsType]["ARTICLES"][1]
				];
	...
	<div class="gifts-bar", data-info='{"max": "<?php echo $giftsParams[$giftsType]["COUNT"]; ?>", "divide": <?php echo json_encode($giftsParams[$giftsType]["DIVIDE_GIFTS"]); ?>}'>
		<div class="page-inner page-inner--w1">
			<div class="gifts-bar-inner">
				<div class="gifts-bar-counter">
					...
					<div class="gifts-bar-counter-nums">
						...
						<span class="gifts-bar-counter-num-all"><?php echo $giftsParams[$giftsType]["COUNT"]; ?></span>
					</div>
				</div>
