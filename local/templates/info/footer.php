      ...
      <div class="footer-row">
	    ...
	    <?$APPLICATION->IncludeComponent(
          ...
          <div class="footer-col footer-col--w1 footer-col--contacts">
            <div class="footer-contacts"><a href="tel:+78632618962" title="Позвонить нам" class="footer-contacts-phone">+7 (863) 261-89-62</a>
              <div class="footer-contacts-schedule">с 09:00 до 19:00</div><a href="mailto:sale@phoenix-plus.ru" class="link link--black">sale@phoenix-plus.ru</a>
            </div>
          </div>
        </div>
      </div>
