...
<div class="page-inner page-inner--w1">
		...
		$GLOBALS['CATALOG_CURRENT_ELEMENT_ID'] = $elementId;?>    
            <?
//	    deb($arResult['VARIABLES'], false);

//deb($GLOBALS['CATALOG_CURRENT_ELEMENT_ID'] );
		
		$GLOBALS["productDetailFilter"] = Array(
			"!ID" => $elementId,
			">CATALOG_QUANTITY" => "0",
		);
	    //deb($GLOBALS["productDetailFilter"]);
		$APPLICATION->IncludeComponent(
			...
			array(
				...
				'SECTION_ID' => $arResult['VARIABLES']['SECTION_ID'],
				'SECTION_CODE' => $arResult['VARIABLES']['SECTION_CODE'],
				'ELEMENT_SORT_FIELD' => 'PROPERTY_KHIT',
				...
				"FILTER_NAME" => "productDetailFilter",
				"SET_TITLE" => "N",
				"SET_BROWSER_TITLE" => "N",
				"SET_META_KEYWORDS" => "N",
				...
				"TEMPLATE" => [
					"IS_SLIDER" => "Y",
					"TITLE" => "Вас также может заинтересовать",
				],
