...
<div class="page-inner page-inner--w1">
	...
	<div class="catalog-sort">
		...
		<select class="form-item--select" onchange="document.location = '<?=$APPLICATION->GetCurPage()?>?perpage='+$(this).val();">
			...
			<option<? if ($kpoint == perSearchPageClass::getValue()) { ?> selected=""<? } ?> value="<?=$kpoint?>"><?=$point?></option>
		    <? } ?>
		</select>
	...
	<?
		...
		$GLOBALS[$arParams["FILTER_NAME"]]["PROPERTY_STATUS_TOVARA"] = CGCHelper::getPropertyIDByCode("STATUS_TOVARA", "Скидка");
	//deb($arResult["FOLDER"].$arResult["URL_TEMPLATES"]["smart_filter"]);
