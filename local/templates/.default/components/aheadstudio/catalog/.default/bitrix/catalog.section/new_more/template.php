    ...
    <div class="page-inner page-inner--w1">
        <div class="catalog">
            <div class="catalog-header">
                <div class="catalog-title"><a href="/catalog/new/" class="link link--black">Новинки</a></div>
                <?php if (count($arResult['ITEMS']) > 4): ?>
                    <div class="catalog-nav"><span class="catalog-nav-item catalog-nav-item--prev"></span><span
                                class="catalog-nav-counter"><span class="catalog-nav-counter-current">1</span><span
                                    class="catalog-nav-counter-divider">/</span><span class="catalog-nav-counter-all">&nbsp;</span></span><span
                                class="catalog-nav-item catalog-nav-item--next"></span></div>
                    <div class="catalog-link">
                        <a href="/catalog/new/" class="link link--black">Показать все</a>
                    </div>
                <?php endif; ?>
            </div>
            <div <?php if (count($arResult['ITEMS']) > 4): ?> data-slick="{&quot;slidesToShow&quot;: 4, &quot;slidesToScroll&quot;: 4}"<?php endif; ?>
                    class="catalog-items">
                <? foreach ($arResult['ITEMS'] as $arItem) { //deb($arItem['MIN_PRICE'], false)?>
                    <div class="catalog-item catalog-item--w1">
                        <div class="catalog-item-inner"><a href="<?= customDetailUrl($arItem['DETAIL_PAGE_URL']) ?>"
                                                           class="catalog-item-link animation-link">
