...
<? $this->SetViewTarget('search_cnt'); ?>
                <div class="catalog-search-count"><?=$arResult["NAV_RESULT"]->NavRecordCount?> <?=getNumEnding($arResult["NAV_RESULT"]->NavRecordCount, array('совпадение','совпадения','совпадений'));?></div>
<? $this->EndViewTarget(); ?> 
