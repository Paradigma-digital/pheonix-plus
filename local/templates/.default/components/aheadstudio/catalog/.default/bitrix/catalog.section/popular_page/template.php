...
<div itemprop="breadcrumb" class="page-breadcrumbs">
    ...
    <? foreach ($arResult['PATH'] as $arSection) { ?>
        ...
        <? } ?>
    <? } ?>
    <div class="page-breadcrumbs-item-holder"><span class="page-breadcrumbs-item"><span itemprop="name" class="page-breadcrumbs-item-name">Популярные товары</span></span>
    </div>
</div>
<div class="catalog-heading">
    <h1 class="h1 catalog-heading-title">Популярные товары</h1>
                    ...
                    <div class="catalog-item catalog-item--w1">
                        <div class="catalog-item-inner"><a href="<?=customDetailUrl($arItem['DETAIL_PAGE_URL'])?>" class="catalog-item-link">
                                <? if (!empty($arItem['PREVIEW_PICTURE'])) { ?>
                                    <div class="catalog-item-photo-holder"><img src="<?=$arItem['PREVIEW_PICTURE']['SRC']?>" alt="<?=$arItem['PREVIEW_PICTURE']['ALT']?>" class="catalog-item-photo">
                                        <div class="catalog-item-add2favorites <?php if(СGCBookmark::isProductInFavorites($arItem["ID"])): ?>added<?php endif; ?>" data-id="<?php echo $arItem["ID"]; ?>"></div>
                                    </div>
                                <? } else { ?>
