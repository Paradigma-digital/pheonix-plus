		...
		<div class="catalog-item-inner"><a href="<?=customDetailUrl($arItem['DETAIL_PAGE_URL'])?>" class="catalog-item-link">
			<? if (!empty($arItem['PREVIEW_PICTURE'])) { ?>
			    <div class="catalog-item-photo-holder">
				    <img src="<?=$arItem['PREVIEW_PICTURE']['SRC']?>" alt="<?=$arItem['PREVIEW_PICTURE']['ALT']?>" class="catalog-item-photo">
					
					<div class="catalog-item-removeFromfavorites" data-id="<?php echo $arItem["ID"]; ?>"></div>
					
					<?php if(0): ?><div class="catalog-item-add2basket" data-id="<?php echo $arItem["ID"]; ?>"></div><?php endif; ?>
