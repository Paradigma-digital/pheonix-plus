				...
				<div class="page-inner page-inner--w2">
					<?php foreach ($arResult["QUESTIONS"] as $arQuestion): ?>
						<div class="profile-section-inner-row">
							...
							<div class="profile-section-title profile-section-title--large"><?php echo $arQuestion["QUESTION"]; ?><?php if($arQuestion["REQUIRED"] == "Y"): ?><span class="required">*</span><?php endif; ?></div>
							
							
							
							<div class="vote-photos">
								<div class="vote-photos-items">
									<?php foreach($arQuestion["VARS"] as $arQuestionVar): ?>
										<label class="vote-photo-item">
											<div class="vote-photo-item-photo">
												<img src="<?php echo $arQuestionVar["PICTURE"]["SRC"]; ?>" />
											</div>
											<div class="vote-photo-item-title"><?php echo $arQuestionVar["NAME"]; ?></div>
											<div class="vote-photo-item-age"><?php echo $arQuestionVar["AGE"]; ?></div>
											
											<input type="checkbox" class="form-item form-item--checkbox" value="<?php echo $arQuestionVar["NAME"]; ?>" />
										</label>
									<?php endforeach; ?>
								</div>
							</div>
...
<div class="page-popup mfp-hide" id="vote-info">
	<div class="page-text"><div class="center"><b>Вы можете выбрать не более трех работ</b></div></div>
</div>
<?php endif; ?>