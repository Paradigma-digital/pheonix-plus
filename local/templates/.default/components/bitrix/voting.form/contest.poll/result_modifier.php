...
foreach($arResult["QUESTIONS"] as &$arQuestion) {
	$arSection = CGCHelper::getIBlockSections([
		"FILTER" => [
	...
	$arSection = $arSection[0];
	$arAnswers = CGCHelper::getIBlockElements([
		"SORT" => [
			"RAND" => "ASC",
		],
		"FILTER" => [
	...
	foreach($arAnswers as &$arAnswerItem) {
		$arAnswerItem["PICTURE"] = CGCHelper::resizeImage($arAnswerItem["PREVIEW_PICTURE"], "500", "500");
		$arAnswerItem["AGE"] = $arAnswerItem["PROPERTY_AGE_VALUE"];
	}
	$arQuestion["VARS"] = $arAnswers;
}
