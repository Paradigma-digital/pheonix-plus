...
if (strlen($request->get('ORDER_ID')) > 0) {
    ...
    <div class="page-inner page-inner--w1">
        ...
        <form action="<?= POST_FORM_ACTION_URI ?>" method="POST" name="ORDER_FORM" id="bx-soa-order-form"
            ...
            <?php foreach ($arParams["USER_PROFILES"] as $profileItemID => $arProfileItem): ?>
                <input type="hidden" name="ORDER_PROP_18" value="<?= $arProfileItem["COMPANY_ID"]; ?>">
            <?php endforeach; ?>
            <input type="hidden" name="ORDER_PROP_39" value="<?php echo $arParams["NDS_INFO"]["TYPE"]; ?>">
            ...
            <div id="bx-soa-order" class="row bx-<?= $arParams['TEMPLATE_THEME'] ?>" style="opacity: 0">
                ...
                <div class="col-sm-9 bx-soa">
                    ...
                    <? if ($arParams['BASKET_POSITION'] === 'before'): ?>
                        ...
                        <div id="bx-soa-basket" data-visited="false" class="bx-soa-section bx-active">
                            <div class="bx-soa-section-title-container">
                                ...
                                <!--<div class="col-xs-12 col-sm-3 text-right"><a href="javascript:void(0)" class="link link--black bx-soa-editstep"><?= $arParams['MESS_EDIT'] ?></a></div>-->
                            </div>
                            <div class="bx-soa-section-content container-fluid"></div>
                        </div>
                    <? endif ?>
                    ...
                    <div id="bx-soa-region" data-visited="false" class="bx-soa-section bx-active">
                        <div class="bx-soa-section-title-container">
                            ...
                            <div class="col-xs-12 col-sm-3 text-right"><a href=""
                                                                          class="link link--black ep bx-soa-editstep"><?= $arParams['MESS_EDIT'] ?></a>
                            </div>
                        </div>
                        <div class="bx-soa-section-content container-fluid"></div>
                    </div>
                    ...
                    <? if ($arParams['DELIVERY_TO_PAYSYSTEM'] === 'p2d'): ?>
                        ...
                        <div id="bx-soa-paysystem" data-visited="false" class="bx-soa-section bx-active">
                            <div class="bx-soa-section-title-container">
                                ...
                                <div class="col-xs-12 col-sm-3 text-right"><a href=""
                                                                              class="link link--black bx-soa-editstep"><?= $arParams['MESS_EDIT'] ?></a>
                                </div>
                            </div>
                            <div class="bx-soa-section-content container-fluid"></div>
                        </div>
                    ...
                    <div id="bx-soa-properties" data-visited="false" class="bx-soa-section bx-active">
                        <div class="bx-soa-section-title-container">
                            <h2 class="bx-soa-section-title col-sm-9">
                                <span class="bx-soa-section-title-count"></span>Контакты покупателя
                            </h2>
                            <div class="col-xs-12 col-sm-3 text-right"><a href=""
                                                                          class="link link--black bx-soa-editstep"><?= $arParams['MESS_EDIT'] ?></a>
                            </div>
                    ...
                    <div id="bx-soa-orderSave">
                        ...
                        if($_REQUEST["mode"] != "pre_order"){
                            ...
                            <div class="order-save-note">
                                <b>Внимание!</b><br/>Отгрузка товаров осуществляется только после
                                100% предоплаты.
                            </div>
                            <?
                        }
                        ...
                        <a href="javascript:void(0)" class="pull-right button button--red button--large hidden-xs"
                           data-save-button="true">
                            Оформить заказ <?if($_REQUEST["mode"] != "pre_order"){?>и оплатить<?}?>
                        </a>
                    </div>
    ...
    <script>
        ...
        BX.Sale.OrderAjaxComponentExt.init({
            preOrder: '<?= $_REQUEST["mode"] == "pre_order"?>',
    ...
    if($_REQUEST["mode"] == "pre_order"){
        ...
        ?>
    BX.ready(function(){
        console.log(BX("bx-soa-paysystem"));
        if (BX("bx-soa-paysystem")) {
            BX("bx-soa-paysystem").style.display = "none!important";
            // bx-soa-orderSave
        }
