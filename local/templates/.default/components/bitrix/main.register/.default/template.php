			...
			<article class="article">
				...
				<div class="article-content">
					<div class="article-text page-text">
					      <p>Для подтверждения регистрации перейдите по ссылке из письма, отправленного на указанный при регистрации e-mail.
					      </p>
					</div>
				</div>
			</article>
	...
	<? } else { ?>
		<div class="page-inner page-inner--w1">
			<div class="page-heading">
				<h1 class="h1">Регистрация <?php if($arParams["TYPE"] == "SIMPLE"): ?>пользователя<?php elseif($arParams["TYPE"] == "BUSINESS"): ?>партнера<?php endif; ?></h1>
			</div>
		</div>
		<div class="page-inner page-inner--w1">
		    <div class="profile">
				...
				<form class="form form--register" method="post" action="<?=POST_FORM_ACTION_URI?>" name="regform" enctype="multipart/form-data">
				    ...
				    <div class="form-title">
						...
						<?php elseif($arParams["TYPE"] == "BUSINESS"): ?>
						    ...
						    <div class="form-title-text">Не являетесь юр. лицом? <a href="/register/simple/" class="link link--black">Зарегистрируйтесь как пользователь</a></div>
				    ...
				    <div class="form-row ">
						Нажимая на кнопку "Создать профиль", вы соглашаетесь с нашим <a class="link link--black" href="#">Пользовательским соглашением</a> и подтверждаете правильность введённых данных, а также принимаете условия <a href="/Политика-Конфеденциальности.pdf" class="link link--black" target="_blank">политики конфиденциальности информации</a>.
				    </div>
