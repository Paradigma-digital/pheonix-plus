...
if($arParams["SEF_MODE"] == "Y")
{
	...
	if(strstr($APPLICATION->GetCurDir(), "catalog/popular")) {
		$componentPage = "popular";
	}
	
	if(strstr($APPLICATION->GetCurDir(), "catalog/new")) {
		$componentPage = "new";
	}
	
	if(strstr($APPLICATION->GetCurDir(), "catalog/actions")) {
		$componentPage = "actions";
	}
	...
	if($componentPage == "section") {
		...
		$arResult["ELEMENT_CNT"] = $dbSectionItems->SelectedRowsCount();
	}
}
else
{
